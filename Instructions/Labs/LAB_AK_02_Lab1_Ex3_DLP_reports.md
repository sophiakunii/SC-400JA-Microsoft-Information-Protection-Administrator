...
3. 左側のナビゲーション ウィンドウで、「**Roles&Scopes**」を選択し、**「アクセス許可」** を選択します。**「Microsoft Purview ソリューション」** で、**「役割」** を選択します。 

4. 検索から「*Security*」と入力して、「**Security Reader**」を選択します。

4. *「Security Reader」* ウィンドウで、**「編集」** を選択します。

5. 「**役割グループのメンバーの編集**」ページで、「**+ ユーザーの選択**」を選択します。

6. 「**Megan Bowen**」を検索し、名前の前にあるチェックボックスを選択して、「**選択**」を選択します。

8. 「**保存**」を選択し、更新されたことを確認して「**完了**」を選択します。「**セキュリティ閲覧者** ロール」ペインを閉じます。
