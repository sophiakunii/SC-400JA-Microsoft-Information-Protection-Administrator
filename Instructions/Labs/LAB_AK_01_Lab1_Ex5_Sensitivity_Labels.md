...
33. 「**ドキュメントに既定のラベルを適用する**」ページで「**次へ**」を選択します。

34. 「**電子メールに既定のラベルを適用する**」ページで「**次へ**」を選択します。

35. 「**Power BI コンテンツに既定のラベルを適用する (プレビュー)**」ページで「**次へ**」を選択します。 

36. 「**ポリシーの名前を設定**」ページで、次の情報を入力します。
...
38. 「**確認と完了**」ページで、「**送信**」を選択します。

39. ポリシーが作成され、完了すると「**新しいポリシーが作成されました**」というメッセージが表示されます。
