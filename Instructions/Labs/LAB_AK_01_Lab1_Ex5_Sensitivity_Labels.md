...
4. 「情報の保護」ページの「**ラベル**」タブで、「**+　ラベルを作成**」を選択します。
...
22. 「**ファイルと電子メールの保護設定の選択**」ページで、「**ファイルとメールを暗号化**」オプションを選択します。
...
27. 「アクセス許可の割り当て」メニューで、「**+ 任意の認証済みユーザーの追加**」を選択します。
...
33. 「**設定の確認して完了**」ページで、「**ラベルの作成**」を選択します。

34. ラベルが作成され、完了すると「**ラベルが作成されました**」というメッセージが表示されます。

35. 「秘密度ラベルが作成されました」ページで、「**ポリシーをまだ作成しない**」を選択し、「**完了**」を選択します。
...
11. 「**ユーザーとグループに発行する**」ページで「**次へ**」を選択します。
